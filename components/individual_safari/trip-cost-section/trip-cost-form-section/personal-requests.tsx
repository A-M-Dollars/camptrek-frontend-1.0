  ...
  return (
    <div className='mt-12 xl:mt-0'>
      ...
      <div className='grid grid-row gap-2 mt-4 mb-4'>
        {/* Dietary Needs */}
        <label className='text-[10px] titlecase pl-1 font-light'>Dietary Needs</label>
        <input
          type="text"
        ...
        <label className='text-[10px] titlecase pl-1 font-light'>Additional Information</label>
        <textarea
          rows={5}
          {...register('dietInfo')}
        ...
        <label className='text-[10px] titlecase pl-1 font-light'>Special Occassion (Requests)</label>
        <input
          type="text"
