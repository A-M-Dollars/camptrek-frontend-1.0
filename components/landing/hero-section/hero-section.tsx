        ...
        <div>
            <div className="overflow-x-hidden relative w-screen ">
                ...
                <div className="relative z-10 mb-10 xl:mb-0  h-full text-black">
                    ...
                    h-[70px] mt-10 bg-white xl:w-[35%] md:w-[60%] ml-2 mr-2 xl:mr-2 xl:ml-10 rounded'>
                    ...
                    <div className='mt-[80%] xl:mt-[20%] xl:mb-12 flex justify-end'>
                        <div className='hidden lg:block mt-[-110] w-[50%] md:w-[30%] xl:w-[15%] mr-10'>
                            ...
                            <Link href={'/safaris'}>
                                <button
                                 ...
                                 h-[50px] lg:h-[55px] w-full mr-10 uppercase text-[14px] lg:text-[14px] rounded
                                '>
