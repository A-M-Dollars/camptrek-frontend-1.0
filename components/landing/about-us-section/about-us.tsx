    ...
    return (
        <div className='over-flow-hidden text-black bg-white'>
            <div className='mt-10 ml-5 xl:ml-25'>
                <h1 className='font-semibold text-[30px] xl:text-[32px]'>WHY CHOOSE CAMPTREK SAFARIS ?</h1>
            ...
            <div className='flex w-full'>
                ...
                <div className=" xl:w-[45%] mt-5 xl:mt-30 pr-15 ml-5 xl:ml-0 xl:pr-25">
                    <div className='flex flex-row mb-15 mt-15'>
                        <div className='bg-[#ED1C24] h-[70px] xl:h-[70px] w-[140px] xl:w-[70px] flex justify-center items-center'>
                            <h1 className='text-white  font-extrabold text-[32px]'>01</h1>
                        </div>
                        <div className='ml-10'>
                            <h2 className='text-[20px] font-semibold'>The Best Travel Destinatios</h2>
                    ...
                    <div className='flex flex-row mb-15 mt-15'>
                        ...
                        <div className='ml-10'>
                            <h2 className='text-[20px] font-semibold'>All-inclusive Africa Safari Tours</h2>
                            <p className='text-[14px] mt-2 text-gray-600'>
                    ...
                    <hr />
                    <div className='flex flex-row mb-15 mt-15'>
                        <div className='bg-[#ED1C24] h-[70px] xl:h-[70px] w-[160px] xl:w-[70px] flex justify-center items-center'>
                            <h1 className='text-white  font-extrabold text-[32px]'>03</h1>
                        </div>
                        <div className='ml-10'>
                            <h2 className='text-[20px] font-semibold'>The perfect blend of wildlife and relaxation</h2>
                            <p className='text-[14px] mt-2 text-gray-600'>
                    ...
                    <div className='mt-10 mb-5 flex justify-center items-center'>
                        <button className='bg-[#ED1C24] font-light text-[16px] text-white p-4 cursor-pointer'>GET TO KNOW MORE ABOUT US</button>
                    </div>
                </div>
            </div>
        </div>
